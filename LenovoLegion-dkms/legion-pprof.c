...
void legion_platform_profile_exit()
{}
...
{
	struct legion_data *data = container_of(pprof, struct legion_data, platform_profile_handler);
...
{
	data->platform_profile_handler.profile_get = legion_platform_profile_get;
	data->platform_profile_handler.profile_set = legion_platform_profile_set;

	set_bit(PLATFORM_PROFILE_QUIET, data->platform_profile_handler.choices);
	set_bit(PLATFORM_PROFILE_BALANCED,data->platform_profile_handler.choices);
	set_bit(PLATFORM_PROFILE_BALANCED_PERFORMANCE,data->platform_profile_handler.choices);
	set_bit(PLATFORM_PROFILE_PERFORMANCE,data->platform_profile_handler.choices);

	return platform_profile_register(&data->platform_profile_handler);
}
