    ...
    ui(new Ui::OpenRGBZoneResizeDialog)
{
    ...
    unsigned int size_min     = edit_dev->GetZones()[edit_zone_idx].leds_min;
    unsigned int size_max     = edit_dev->GetZones()[edit_zone_idx].leds_max;
    unsigned int size_current = edit_dev->GetZones()[edit_zone_idx].leds_count;
    ...
    for(unsigned int segment_idx = 0; segment_idx < edit_dev->GetZones()[edit_zone_idx].segments.size(); segment_idx++)
    {
        ...
        slider_length->setMaximum(edit_dev->GetZones()[edit_zone_idx].leds_count);

        lineedit_name->setText(QString::fromStdString(edit_dev->GetZones()[edit_zone_idx].segments[segment_idx].name));
        lineedit_length->setText(QString::number(edit_dev->GetZones()[edit_zone_idx].segments[segment_idx].leds_count));
        slider_length->setSliderPosition(edit_dev->GetZones()[edit_zone_idx].segments[segment_idx].leds_count);
