...
public:
    explicit OpenRGBZoneResizeDialog(LenovoLegionDaemon::RGBControllerInterface* edit_dev_ptr, unsigned int edit_zone_idx_val, QWidget *parent = nullptr);
...
private:
    ...
    LenovoLegionDaemon::RGBControllerInterface* edit_dev;
